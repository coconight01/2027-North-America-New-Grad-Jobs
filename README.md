...
> Last automated update: **2026-09-11** · Open roles: **1685**
...
| Posted | Company | Role | Salary | Location | Visa | New grad? | PhD |
|---|---|---|---|---|---|---|---|
| 2026-09-11 | **ByteDance** | [Visual Generation & Multimodal Evaluation Researcher Graduate (AML-Ark-US) - 2027 Start (PhD)](https://joinbytedance.com/search/7672392998192154885) | $153900 - $300960 annually | Seattle, Washington | ❔ | ◐ Likely | PhD only |
...
The repository currently keeps **1685 active roles**. Featured groups account for **156** of them. Browse the full searchable list in the **[Job Radar](https://coconight01.github.io/2027-North-America-New-Grad-Jobs/)**, or use data/jobs.csv / data/jobs.json.
