...
> Last automated update: **2026-09-15** · Open roles: **1719**
...
| **ByteDance / TikTok** (separate) | 349 |
| Other companies | 1223 |
...
<details><summary><b>349 active roles</b> — collapsed so one company does not dominate the README</summary>
...
_Showing 12 of 349 active roles. Use the Job Radar for all roles._

</details>

## All roles

The repository currently keeps **1719 active roles**. Featured groups account for **147** of them. Browse the full searchable list in the **[Job Radar](https://coconight01.github.io/2027-North-America-New-Grad-Jobs/)**, or use data/jobs.csv / data/jobs.json.
